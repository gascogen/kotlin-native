...
class StubIrTextEmitter(
            ...
            when {
                ...
                element is ClassStub.Companion && element.children.isEmpty() -> out(header)
                    ...
                    if (element is ClassStub.Enum) {
                        ...
                        element.children
                                // We render primary constructor as part of a header.
                ...
                is PropertyStub.Kind.Val -> {
                    val shouldWriteInline = kind.getter.let {
                        (it is PropertyAccessor.Getter.SimpleGetter && it.constant != null)
                                ...
                                || it is PropertyAccessor.Getter.ConstructorParameter
                    }
    ...
    private fun renderClassHeader(classStub: ClassStub): String {
        ...
        val constructorParams = classStub.primaryConstructor?.parameters?.let(this::renderConstructorParams) ?: ""
    ...
    private fun renderGetter(accessor: PropertyAccessor.Getter): String {
        ...
        return annotations + when (accessor) {
            ...
            is PropertyAccessor.Getter.ConstructorParameter -> "= ${renderPropertyAccessorBody(accessor)}"
            else -> {
    ...
    private fun renderPropertyAccessorBody(accessor: PropertyAccessor): String = when (accessor) {
        ...
        is PropertyAccessor.Getter.ConstructorParameter -> accessor.constructorParameter.name
